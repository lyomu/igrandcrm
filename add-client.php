...
<html lang="en">
    <head>
        <meta charset="UTF-8"><title>Client Details</title>
...
<!-- Navbar ends here -->
    <div class="zf-templateWidth"><form action='https://forms.zohopublic.com/einsbrandmarketing/form/ClientDetails/formperma/7QvtVwPcIOyGv5qiXyQA853CXNRZKa3Oz7kapfKeixU/htmlRecords/submit' name='form' method='POST' onSubmit='javascript:document.charset="UTF-8"; return zf_ValidateAndSubmit();' accept-charset='UTF-8' enctype='multipart/form-data' id='form'><input type="hidden" name="zf_referrer_name" value=""><!-- To Track referrals , place the referrer name within the " " in the above hidden input field -->
...
<input class="zf-radioBtnType" type="radio" id="Radio_1" name="Radio" checktype="c1" value="Email">
<label for="Radio_1" class="zf-radioChoice">Email</label> </span>
<span class="zf-multiAttType"> 
<input class="zf-radioBtnType" type="radio" id="Radio_2" name="Radio" checktype="c1" value="Phone">
...
<div class="zf-tempContDiv">
<span> <input type="text" maxlength="2083" name="Website" checktype="c6" value="" placeholder=""/></span> <p id="Website_error" class="zf-errorMessage" style="display:none;">Invalid value</p>
</div><div class="zf-clearBoth"></div></li><!---------Website Ends Here---------->
<!--fileupload-->
<!---------File Upload Starts Here---------->  
<li class="zf-tempFrmWrapper"><label class="zf-labelName">Company Registration Certificate
</label>
<div class="zf-tempContDiv">
...
<div class="zf-tempContDiv">
<span> <input type="text" name="SingleLine4" checktype="c1" value="" maxlength="255" fieldType=1 placeholder=""/></span> <p id="SingleLine4_error" class="zf-errorMessage" style="display:none;">Invalid value</p>
</div><div class="zf-clearBoth"></div></li><!---------Single Line Ends Here---------->
<!---------Phone Starts Here----------> 
<li  class="zf-tempFrmWrapper zf-small"><label class="zf-labelName"> 
Director's Phone 
...
class="zf-phwrapper zf-phNumber"  
>
<span> <input type="text" compname="PhoneNumber1" name="PhoneNumber1_countrycode" maxlength="20" checktype="c7" value="" phoneFormat="1" isCountryCodeEnabled=false fieldType="11" id="international_PhoneNumber1_countrycode" valType="number" phoneFormatType="1" placeholder="" />
<label>Number</label> </span>
...
<!--fileupload-->
<!---------File Upload Starts Here---------->  
<li class="zf-tempFrmWrapper"><label class="zf-labelName">Document 1
</label>
<div class="zf-tempContDiv">
<input type="file"  name="FileUpload1" checktype="c1"  multiple="multiple"/>
<p id="FileUpload1_error" class="zf-errorMessage" style="display:none;">Choose any file for this field.</p>
<p class="zf-instruction"> Give the file an appropriate name</p>
</div><div class="zf-clearBoth"></div></li><!---------File Upload Ends Here---------->  
<!--fileupload-->
<!---------File Upload Starts Here---------->  
<li class="zf-tempFrmWrapper"><label class="zf-labelName">Document 2
</label>
<div class="zf-tempContDiv">
...
<!--fileupload-->
<!---------File Upload Starts Here---------->  
<li class="zf-tempFrmWrapper"><label class="zf-labelName">Document 3
</label>
<div class="zf-tempContDiv">
<input type="file"  name="FileUpload3" checktype="c1"  multiple="multiple"/>
<p id="FileUpload3_error" class="zf-errorMessage" style="display:none;">Choose any file for this field.</p>
<p class="zf-instruction"> Give the file an appropriate name</p>
</div><div class="zf-clearBoth"></div></li><!---------File Upload Ends Here---------->  
<!--fileupload-->
<!---------File Upload Starts Here---------->  
<li class="zf-tempFrmWrapper"><label class="zf-labelName">Document 4
</label>
<div class="zf-tempContDiv">
<input type="file"  name="FileUpload4" checktype="c1"  multiple="multiple"/>
<p id="FileUpload4_error" class="zf-errorMessage" style="display:none;">Choose any file for this field.</p>
<p class="zf-instruction"> Give the file an appropriate name</p>
</div><div class="zf-clearBoth"></div></li><!---------File Upload Ends Here---------->  
<!--fileupload-->
<!---------File Upload Starts Here---------->  
<li class="zf-tempFrmWrapper"><label class="zf-labelName">Document 5
</label>
<div class="zf-tempContDiv">
<input type="file"  name="FileUpload5" checktype="c1"  multiple="multiple"/>
<p id="FileUpload5_error" class="zf-errorMessage" style="display:none;">Choose any file for this field.</p>
<p class="zf-instruction"> Give the file an appropriate name</p>
</div><div class="zf-clearBoth"></div></li><!---------File Upload Ends Here---------->  
...
var zf_MandArray = [ "SingleLine", "SingleLine1", "SingleLine3", "Radio", "Email", "PhoneNumber_countrycode", "Website", "SingleLine4", "PhoneNumber1_countrycode"]; 
var zf_FieldArray = [ "SingleLine", "SingleLine1", "SingleLine3", "SingleLine2", "Radio", "Email", "PhoneNumber_countrycode", "Website", "FileUpload2", "SingleLine4", "PhoneNumber1_countrycode", "MultiLine", "FileUpload1", "FileUpload", "FileUpload3", "FileUpload4", "FileUpload5"]; 
